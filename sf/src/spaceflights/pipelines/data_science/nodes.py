...
def train_model_azure(
    X_train_path: str, estimator_kwargs: Dict[str, Any]
) -> str:
    ...
    compute_target = ws.compute_targets['githubcluster']
    src = ScriptRunConfig(source_directory='.',
                      script='azureml_entry_point.py',
    ...
    model_path = job_description["ModelArtifacts"]["BlobModelArtifacts"] ## Question: How to get the path?
    return model_path
